<form class="space-y-8 divide-y divide-gray-200 col-span-8">
    <div class="space-y-8 divide-y divide-gray-200">
        ...
        <div class="pt-8">
            ...
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div class="sm:col-span-2">
                    <label for="postal-code" class="block text-sm font-medium text-gray-700"> ZIP / Postal code
                    </label>
                    <div class="mt-1">
        ...
        <div class="pt-8">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">We'll always let you know about important changes, but you pick
                    what else
            ...
            <div class="mt-6">
                ...
                <fieldset class="mt-6">
                    ...
                    <p class="text-sm text-gray-500">These are delivered via SMS to your mobile         .</p>
                    <div class="mt-4 space-y-4">
