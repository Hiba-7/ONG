    ...
    <div class="hidden sm:block col-span-8" aria-hidden="true">
        <div class="py-5">
            <div class="border-t border-gray-200"></div>
        </div>
    </div>

    <div class="mt-10 sm:mt-0 col-span-8">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                                ...
                                <div class="mt-4 space-y-4">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="push-nothing"
                                            class="ml-3 block text-sm font-medium text-gray-700"> No push notifications
                                        </label>
                                    </div>
                                </div>
                            </fieldset>
