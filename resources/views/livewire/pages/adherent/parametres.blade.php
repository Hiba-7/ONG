            ...
            <ol role="list" class="overflow-hidden">
                    ...
                    <a x-on:click="activeTab = 'monprofile'" href="#monprofile"
                        ...
                        <span class="ml-4 min-w-0 flex flex-col">
                            <span
                                ...
                                Mon Profile</span>
                            <span class="text-xs 2xl:text-s text-gray-500">Visualiser votre profile et le modifier si
                                vous souhaiter</span>
                        </span>
                    </a>
                </li>
                <a x-on:click="activeTab = 'paiement'" href="#paiement"
                    ...
                    <span class="h-9 flex items-center" aria-hidden="true">
                        ...
                        <span class="ml-4 min-w-0 flex flex-col">
                            <span
                                x-bind:class="activeTab == 'paiement' ? 'text-xs 2xl:text-s font-bold tracking-wide  text-blue-600' :
                                    'text-xs 2xl:text-s font-bold tracking-wide text-gray-500'">
                                Paiement</span>
